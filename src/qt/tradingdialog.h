...
private slots:
    ...
    void on_BuyDGD_clicked();
    void on_SellDGDBTN_clicked();
    void on_SellBidcomboBox_currentIndexChanged(const QString &arg1);
    void on_Sell_Max_Amount_clicked();
    void on_UnitsInputDGD_textChanged(const QString &arg1);
    ...
    QString BuyDGD(QString OrderType, double Quantity, double Rate);
    QString SellDGD(QString OrderType, double Quantity, double Rate);
