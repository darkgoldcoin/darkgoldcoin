...
static const int LAST_POW_BLOCK = 46807; // at 60 second blocks will be about 30 days from launch 43200
...
static const uint256 hashGenesisBlock("00000794402ae20335701ab49adfe71cd25a746f76d11d2a489dd984f3c9faaf");
static const uint256 hashGenesisBlockTestNet("0000b1073e4e33b353f8ec4a0a070d8bd393f79609846a20795b8957876924c9");
...
public:
    ...
    {
        // Darkgold: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // Darkgold: get transaction coin age
...
public:
    ...
    // Darkgold: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // Darkgold: two types of block: proof-of-work or proof-of-stake
    ...
    // Darkgold: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // Darkgold: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // Darkgold: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // Darkgold: block index flags
    enum  
    {
